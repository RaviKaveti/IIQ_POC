...
public class iiqsd {
	...
	public void theUserEntersUseridAndPassword() throws Throwable {
		...
		extentTest.log(LogStatus.INFO, "Log into the IIQ application");
	...
	public void userClicksOnSetupTabAndChooseRoles() throws Throwable {
		...
		extentTest.log(LogStatus.INFO, "Select the Role option");
	...
	public void enterTheRoleName(String rolename) throws Throwable {
		...
		extentTest.log(LogStatus.INFO, "Search the Role Name");
	...
	public void verifyTheAttributesSection(String strDescrip,String strBusiRoleName, String strBusiDispName, String strOwner )
			throws Throwable{
		extentTest.log(LogStatus.INFO, "*****Verifying the Attribute section parameters*****");
		...
		System.out.println("================== Verifying the Attribute section parameters  ==================");
	...
	public void verifyTheJobcodeOrg_Hrchy_LvlOrgBus_UnitRBITier_AndLending_FundamentalsDetailsForTheRoleNameInTheRoleInformationSection(
		...
		extentTest.log(LogStatus.PASS, "*****Verifying the Matchlist section parameters*****");
		System.out.println("================== Verifying the Matchlist section parameters  ==================");
	...
	@Then("^click on Required Roles section and verify the IT and AD roles(.*)$")
	public void clickOnRequiredRolesTab(String strITAD) throws Throwable 
	{
		extentTest.log(LogStatus.INFO, "*****Verifying the Required Roles section****");
		...
		System.out.println("================== Verifying the Required Roles section  ==================");
		WebElement webitem;
	...
	@And("^verify the Direct Entitlements section parameters(.*),(.*)$")
	public void clickOnDeterineTab(String strDetRolename,String strApplt) throws Throwable {

		String[] strApplication = strApplt.split(";");
		extentTest.log(LogStatus.INFO, "*****Verifying the Direct Entitlements section parameters*****");
		...
		System.out.println("================== Verifying the Direct Entitlements section parameters  ==================");
		List<WebElement> listreqrole = wreqrolsection.findElements(By.tagName("td"));
		Iterator<WebElement> itrreqrole = listreqrole.iterator();
			...
			while(itrreqrole.hasNext())
			{
				...
				if(webreqroletext != null)
				{
					...
					else if(strreqrole1 !=null)
					{
						...
						if(strreqrole1.equals(strDetRolename))
						{
		...
		for(String sapl : strApplication)
		{
			int z=0;
			...
			while(z<3)
			{
				...
				while(itrreqrole13.hasNext())
				{
					...
					if(stritem13.contains(sapl))
					{
						...
						determinecheck(sapl, stritem13,stritem14,stritem15);
						//fg=true;
					}
					/*if(fg==true)
			{
	...
	private void determinecheck(String strfappl,String strappl, String strprop, String strval) {
		...
		try
		{
			if(strappl.equals(strfappl))
			{
				System.out.println("The given Application :"+strfappl+" in schema Matched with "+strappl+", Property code :"+strprop+" and Value :"+strval+"");
				extentTest.log(LogStatus.PASS, "The given Application :"+strfappl+" in schema Matched with "+strappl+", Property code :"+strprop+" and Value :"+strval+"");
			}
			else
			{
				System.out.println("The given Application :"+strfappl+" in schema NOT Matched with "+strappl+", Property code :"+strprop+" and Value :"+strval+"");
				extentTest.log(LogStatus.FAIL, "The given Application :"+strfappl+" in schema NOT Matched with "+strappl+", Property code :"+strprop+" and Value :"+strval+"");
				screenshot(strfappl);
			}
		}
		catch(Exception e)
